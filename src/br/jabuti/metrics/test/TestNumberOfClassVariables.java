...
public class TestNumberOfClassVariables {
	...
	public void tryLoadNotExistenClass(){
		...
		double numberOfInstanceVariables = metrics.ncv(nameOfInputClass);
		assertEquals(-1,numberOfInstanceVariables,0);
	}
	
	@Test
	public void testNumberOfInstanceVariables0(){
		nameOfInputClass = "br.jabuti.metrics.test.testInput.InputTestNumberOfClassVariable0";
		try {
			testProgram = new Program(nameOfInputClass);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void testNumberOfInstanceVariables1(){
		nameOfInputClass = "br.jabuti.metrics.test.testInput.InputTestNumberOfClassVariable1";
		try {
			testProgram = new Program(nameOfInputClass);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void testNumberOfInstanceVariables2(){
		nameOfInputClass = "br.jabuti.metrics.test.testInput.InputTestNumberOfClassVariable2";
		try {
			testProgram = new Program(nameOfInputClass);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void testNumberOfInstanceVariables3(){
		nameOfInputClass = "br.jabuti.metrics.test.testInput.InputTestNumberOfClassVariable3";
		try {
			testProgram = new Program(nameOfInputClass);
		} catch (Exception e) {
			e.printStackTrace();
